...
- 数据采集传输：<mark style="background: #FF5582A6;">Flume</mark>，<mark style="background: #FF5582A6;">Kafka</mark> ，<mark style="background: #ADCCFFA6;">DataX</mark> ，<mark style="background: #FF5582A6;">Maxwell</mark>，Sqoop ，Logstash
...
- 数据计算：<mark style="background: #ADCCFFA6;">Hive</mark>， <mark style="background: #ADCCFFA6;">Spark</mark> ，<mark style="background: #BBFABBA6;">Flink</mark>，Storm ， Tez
