...
type,id,attributes_referencename,relationships_subscriptions_links_self,relationships_subscriptions_links_related,relationships_subscriptiongrouplocalizations_links_self,relationships_subscriptiongrouplocalizations_links_related