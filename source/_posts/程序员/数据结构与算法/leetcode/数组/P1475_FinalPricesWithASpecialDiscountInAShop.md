---
title: P1475_FinalPricesWithASpecialDiscountInAShop  
date: 2023-03-08 01:00:38  
tags: []  
categories:
  - 程序员
  - 数据结构与算法
...
<div><div>Related Topics</div><div><li>栈</li><li>数组</li><li>单调栈</li></div></div><br><div><li>👍 81</li><li>👎 0</li></div>