---
title: P1460_MakeTwoArraysEqualByReversingSubArrays  
date: 2023-03-08 01:00:29  
tags: []  
categories:
  - 程序员
  - 数据结构与算法
...
<div><div>Related Topics</div><div><li>数组</li><li>哈希表</li><li>排序</li></div></div><br><div><li>👍 37</li><li>👎 0</li></div>