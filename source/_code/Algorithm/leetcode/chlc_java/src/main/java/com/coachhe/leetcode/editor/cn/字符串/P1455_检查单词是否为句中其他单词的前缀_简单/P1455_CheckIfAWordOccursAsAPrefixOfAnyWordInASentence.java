...
// 
//
// Related Topics 字符串 字符串匹配 👍 34 👎 0


package com.coachhe.leetcode.editor.cn.字符串.P1455_检查单词是否为句中其他单词的前缀_简单;
...
//		 String searchWork = "burg";
//		 String searchWork = "problem";
		 String searchWork = "you";
		 System.out.println(solution.isPrefixOfWord(sentence, searchWork));
	 }
